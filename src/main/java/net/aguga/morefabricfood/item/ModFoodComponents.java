...
public class ModFoodComponents
{
    ...
    public static final FoodComponent STRAWBERRY_JAM_BREAD = new FoodComponent.Builder().hunger(8).saturationModifier(0.7f).build();
    public static final FoodComponent RASPBERRY_JAM_BREAD = new FoodComponent.Builder().hunger(8).saturationModifier(0.7f).build();
    public static final FoodComponent CHERRY_JAM_BREAD = new FoodComponent.Builder().hunger(8).saturationModifier(0.7f).build();
}
